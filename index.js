...
const DEFAULT_SERVICES = [
  ...
  { id: 11, name: 'مساعدة برمجية', description: 'مساعدة في البرمجة', price: 7200000, category: 'chatgpt', emoji: '💻', active: true },
  { id: 12, name: 'تصميم لوجو AI', description: 'تصميم لوجو بالذكاء الاصطناعي', price: 6300000, category: 'chatgpt', emoji: '✏️', active: true },
  { id: 13, name: 'كتابة مقالات ونصوص', description: 'كتابة مقالات ونصوص', price: 5400000, category: 'chatgpt', emoji: '📝', active: true },
  { id: 14, name: 'إعداد سيرفر Discord', description: 'إعداد سيرفر Discord كامل', price: 7200000, category: 'chatgpt', emoji: '🎮', active: true },
  { id: 15, name: 'ترجمة احترافية', description: 'ترجمة نصوص بأكثر من لغة', price: 4500000, category: 'chatgpt', emoji: '🌐', active: true },
  { id: 16, name: 'صوت AI — نص لكلام', description: 'تحويل النص إلى صوت', price: 3600000, category: 'chatgpt', emoji: '🔊', active: true },
  { id: 17, name: 'صوت AI — كلام لنص', description: 'تحويل الصوت إلى نص', price: 3600000, category: 'chatgpt', emoji: '🎙️', active: true },
  { id: 18, name: 'توليد صور AI', description: 'توليد صور بالذكاء الاصطناعي', price: 1800000, category: 'chatgpt', emoji: '📸', active: true },
  { id: 19, name: 'retouch صور', description: 'retouch احترافي — تنعيم — إزالة عيouns — تحسين ألوان', price: 4200000, category: 'photoshop', emoji: '🖌️', active: true },
  { id: 20, name: 'تصميم بوستر', description: 'تصميم بوستر إعلاني أو ترويجي', price: 6600000, category: 'photoshop', emoji: '🖼️', active: true },
  { id: 21, name: 'تصميم بانر', description: 'تصميم بانر لسوشيال ميديا أو ويب', price: 4800000, category: 'photoshop', emoji: '🎨', active: true },
