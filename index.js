...
const DEFAULT_SERVICES = [
  ...
  { id: 1, name: 'ChatGPT Plus اشتراك شهري', nameEn: 'ChatGPT Plus Monthly', description: 'اشتراك ChatGPT Plus لمدة شهر — GPT-4o — غير محدود', descriptionEn: 'ChatGPT Plus subscription — 1 month — GPT-4o — Unlimited', price: 1666667000, category: 'ai', emoji: '🤖', active: true },
  { id: 2, name: 'Claude Pro اشتراك شهري', nameEn: 'Claude Pro Monthly', description: 'اشتراك Claude Pro لمدة شهر — Claude 3.5 Sonnet — 5x أكثر', descriptionEn: 'Claude Pro subscription — 1 month — 5x more usage', price: 1666667000, category: 'ai', emoji: '🧠', active: true },
  { id: 3, name: 'Midjourney اشتراك', nameEn: 'Midjourney Subscription', description: 'اشتراك Midjourney — توليد صور بالذكاء الاصطناعي — 30 ساعة شهرياً', descriptionEn: 'Midjourney subscription — AI image generation — 30 hrs/month', price: 2500000000, category: 'ai', emoji: '🖼️', active: true },
  { id: 4, name: 'Suno AI توليد موسيقى', nameEn: 'Suno AI Music', description: 'توليد موسيقى بالذكاء الاصطناعي — أي جنس — صوت احترافي', descriptionEn: 'AI music generation — Any genre — Professional quality', price: 833333000, category: 'ai', emoji: '🎵', active: true },
  { id: 5, name: 'ElevenLabs صوت AI', nameEn: 'ElevenLabs Voice AI', description: 'تحويل نص لكلام صوتي بالذكاء الاصطناعي — أصوات واقعية — أي لغة', descriptionEn: 'Text to speech AI — Realistic voices — Any language', price: 416667000, category: 'ai', emoji: '🔊', active: true },
  { id: 6, name: 'CapCut Pro اشتراك', nameEn: 'CapCut Pro Subscription', description: 'اشتراك CapCut Pro — مونتاج بالذكاء الاصطناعي — ميزات متقدمة', descriptionEn: 'CapCut Pro subscription — AI editing — Advanced features', price: 666667000, category: 'ai', emoji: '✂️', active: true },
  { id: 7, name: 'توليد صور AI', nameEn: 'AI Image Generation', description: 'توليد أي صورة بالذكاء الاصطناعي — DALL-E 3 — 3 صور', descriptionEn: 'AI image generation — DALL-E 3 — 3 images', price: 250000000, category: 'ai', emoji: '📸', active: true },
  { id: 8, name: 'صوت AI — نص لكلام', nameEn: 'AI Text to Speech', description: 'تحويل أي نص لصوت طبيعي — اختيار الصوت واللغة والسرعة', descriptionEn: 'Convert text to natural AI voice — Multiple languages + Emotions', price: 166667000, category: 'ai', emoji: '🎙️', active: true },
  { id: 9, name: 'صوت AI — كلام لنص', nameEn: 'AI Speech to Text', description: 'تحويل أي تسجيل صوتي لنص مكتوب — بدقة عالية + سرعة', descriptionEn: 'Convert audio/speech to written text — Accurate + Fast', price: 166667000, category: 'ai', emoji: '📝', active: true },
  { id: 10, name: 'تحليل بيانات AI', nameEn: 'AI Data Analysis', description: 'تحليل أي مجموعة بيانات بالذكاء الاصطناعي — رسوم بيانية + تقارير', descriptionEn: 'Professional data analysis with AI — Charts + Reports + CSV', price: 333333000, category: 'ai', emoji: '📊', active: true },
  // 📺 اشتراكات البث
  { id: 11, name: 'Netflix اشتراك شهري', nameEn: 'Netflix Monthly', description: 'اشتراك Netflix لمدة شهر — فردي أو مشترك — 4K', descriptionEn: 'Netflix subscription — 1 month — Individual or Shared — 4K', price: 833333000, category: 'subscriptions', emoji: '🎬', active: true },
  { id: 12, name: 'Spotify Premium', nameEn: 'Spotify Premium', description: 'اشتراك Spotify Premium لمدة شهر — بدون إعلانات — تحميل', descriptionEn: 'Spotify Premium — 1 month — No ads — Offline download', price: 250000000, category: 'subscriptions', emoji: '🎵', active: true },
  { id: 13, name: 'YouTube Premium', nameEn: 'YouTube Premium', description: 'اشتراك YouTube Premium لمدة شهر — بدون إعلانات — خلف الشاشة', descriptionEn: 'YouTube Premium — 1 month — No ads — Background play', price: 333333000, category: 'subscriptions', emoji: '▶️', active: true },
  { id: 14, name: 'Disney+ / Prime Video', nameEn: 'Disney+ / Prime Video', description: 'اشتراك Disney+ أو Amazon Prime Video لمدة شهر', descriptionEn: 'Disney+ or Amazon Prime Video subscription — 1 month', price: 333333000, category: 'subscriptions', emoji: '🏰', active: true },
  { id: 15, name: 'Crunchyroll أنمي', nameEn: 'Crunchyroll Anime', description: 'اشتراك Crunchyroll — أنمي بدون إعلانات — ترجمة عربية', descriptionEn: 'Crunchyroll subscription — Ad-free anime — Arabic subtitles', price: 250000000, category: 'subscriptions', emoji: '🎌', active: true },
  { id: 16, name: 'Canva Pro اشتراك', nameEn: 'Canva Pro Subscription', description: 'اشتراك Canva Pro — تصميم بدون حدود — قوالب احترافية', descriptionEn: 'Canva Pro subscription — Unlimited design — Professional templates', price: 333333000, category: 'subscriptions', emoji: '🎨', active: true },
  // 🎨 التصميم
  ...
  { id: 18, name: 'تصميم بوستر إعلاني', nameEn: 'Poster Design', description: 'تصميم بوستر إعلاني أو ترويجي — جودة عالية + تعديلات', descriptionEn: 'Professional poster design — Print + Digital — High quality', price: 500000000, category: 'design', emoji: '🖼️', active: true },
  { id: 19, name: 'تصميم بانر', nameEn: 'Banner Design', description: 'تصميم بانر لسوشيال ميديا أو ويب — جميع الأحجام', descriptionEn: 'Professional banner design — Social media + YouTube + Twitch', price: 333333000, category: 'design', emoji: '🎨', active: true },
  { id: 20, name: 'تصميم UI/UX', nameEn: 'UI/UX Design', description: 'تصميم واجهة مستخدم احترافية — Mockups + Prototypes', descriptionEn: 'Modern UI/UX design — Mockups + Prototypes', price: 3333333000, category: 'design', emoji: '📱', active: true },
  { id: 21, name: 'تصميم هوية بصرية', nameEn: 'Brand Identity Design', description: 'تصميم هوية بصرية كاملة — لوجو + ألوان + خطوط + بطاقات', descriptionEn: 'Complete brand identity — Logo + Colors + Typography + Guidelines', price: 5000000000, category: 'design', emoji: '💼', active: true },
  { id: 22, name: 'تصميم Thumbnail يوتيوب', nameEn: 'YouTube Thumbnail', description: 'تصميم صورة غلاف لليوتيوب — جذابة + احترافية + عالية الجودة', descriptionEn: 'Professional YouTube thumbnail — Eye-catching + High quality', price: 250000000, category: 'design', emoji: '📺', active: true },
  { id: 23, name: 'retouch صور', nameEn: 'Photo Retouching', description: 'retouch احترافي للصور — تنعيم البشرة — إزالة العيوب — تحسين الألوان', descriptionEn: 'Professional photo retouching — Skin smoothing + Color correction', price: 166667000, category: 'design', emoji: '🖌️', active: true },
  ...
  // 🎬 المونتاج
  { id: 25, name: 'مونتاج فيديو احترافي', nameEn: 'Professional Video Editing', description: 'مونتاج فيديو احترافي — قص + ترتيب + انتقالات + موسيقى', descriptionEn: 'Professional video editing — Cuts + Transitions + Effects', price: 2500000000, category: 'montage', emoji: '🎬', active: true },
  { id: 26, name: 'مونتاج Reels / تيك توك', nameEn: 'Reels / TikTok Editing', description: 'مونتاج ريلز أو تيك توك — سرعة + تأثيرات + موسيقى ترند', descriptionEn: 'Short-form video editing — Reels + TikTok + Viral effects', price: 500000000, category: 'montage', emoji: '📱', active: true },
  { id: 27, name: 'مونتاج يوتيوب', nameEn: 'YouTube Video Editing', description: 'مونتاج فيديو يوتيوب كامل — قص + موسيقى + تأثيرات + ترجمة', descriptionEn: 'Professional YouTube video editing — Cuts + Thumbnails + Effects', price: 3333333000, category: 'montage', emoji: '▶️', active: true },
  { id: 28, name: 'تصميم إنтро/أوترو', nameEn: 'Intro/Outro Design', description: 'تصميم مقدمة ونهاية للفيديوهات — أنيميشن + لوجو', descriptionEn: 'Professional intro/outro for YouTube — Animation + Sound', price: 833333000, category: 'montage', emoji: '✨', active: true },
  { id: 29, name: 'موشن جرافيك', nameEn: 'Motion Graphics', description: 'تصميم موشن جرافيك — أنيميشن — شرح — إعلانات متحركة', descriptionEn: 'Professional motion graphics — Animation + Effects + Typography', price: 3333333000, category: 'montage', emoji: '🎭', active: true },
  { id: 30, name: 'إنشاء فيديو AI', nameEn: 'AI Video Creation', description: 'إنشاء فيديو بالذكاء الاصطناعي — كرتوني أو واقعي — جودة HD', descriptionEn: 'AI-powered video creation — Script + Voiceover + Editing — HD', price: 1333333000, category: 'montage', emoji: '🤖', active: true },
  // 💻 البرمجة
  { id: 31, name: 'بوت Discord مخصص', nameEn: 'Custom Discord Bot', description: 'إنشاء بوت Discord مخصص — أوامر + تذاكر + أتمتة + إدارة', descriptionEn: 'Custom Discord bot — Commands + Database + Dashboard + Support', price: 2500000000, category: 'dev', emoji: '🤖', active: true },
  { id: 32, name: 'تطوير موقع ويب كامل', nameEn: 'Full Website Development', description: 'تطوير موقع ويب كامل — تصميم + كود + ربط + استضافة', descriptionEn: 'Complete website development — Design + Code + Hosting', price: 5000000000, category: 'dev', emoji: '🌐', active: true },
  { id: 33, name: 'Landing Page', nameEn: 'Landing Page', description: 'تصميم صفحة هبوط احترافية — متجاوبة + سريعة + تحويل عالي', descriptionEn: 'High-converting landing page — Responsive + Fast + SEO', price: 1666667000, category: 'dev', emoji: '📄', active: true },
  { id: 34, name: 'تطوير تطبيق موبايل', nameEn: 'Mobile App Development', description: 'تطوير تطبيق موبايل كامل — Android أو iOS — تصميم + كود', descriptionEn: 'Full mobile app development — Android or iOS — Design + Code', price: 8333333000, category: 'dev', emoji: '📱', active: true },
  { id: 35, name: 'سكربت أتمتة', nameEn: 'Automation Script', description: 'كتابة سكربت لأتمتة أي مهمة — Python, JS — سريع وموثوق', descriptionEn: 'Automation script for any task — Python, JS — Fast + Reliable', price: 833333000, category: 'dev', emoji: '⚙️', active: true },
  { id: 36, name: 'إعداد WordPress', nameEn: 'WordPress Setup', description: 'إعداد و تخصيص موقع WordPress — ثيم + بلاغينات + إعداد', descriptionEn: 'Full WordPress website — Theme + Plugins + Content', price: 1333333000, category: 'dev', emoji: '🔧', active: true },
  { id: 37, name: 'ربط API', nameEn: 'API Integration', description: 'ربط أي API مع مشروعك — REST + JSON + أمان', descriptionEn: 'Connect any API to your app — REST + JSON + Auth', price: 1000000000, category: 'dev', emoji: '🔗', active: true },
  { id: 38, name: 'إصلاح مشكلة برمجية', nameEn: 'Bug Fix', description: 'إصلاح أي bug أو مشكلة في كودك — أي لغة برمجة', descriptionEn: 'Fix any bug or issue in your code — Fast + Reliable', price: 500000000, category: 'dev', emoji: '🐛', active: true },
  // 📚 الخدمات الأكاديمية
  { id: 39, name: 'كتابة مقالات أكاديمية', nameEn: 'Academic Writing', description: 'كتابة أي نوع من المقالات — أكاديمي، تسويقي، تقني، إبداعي', descriptionEn: 'Academic paper writing — Grammar + Style + Citations', price: 333333000, category: 'academic', emoji: '📝', active: true },
  { id: 40, name: 'ترجمة احترافية', nameEn: 'Professional Translation', description: 'ترجمة أي نص — بدقة عالية + سياق طبيعي + مراجعة', descriptionEn: 'Professional translation — Arabic ↔ English + Any language', price: 250000000, category: 'academic', emoji: '🌐', active: true },
  { id: 41, name: 'حلول رياضيات', nameEn: 'Math Solutions', description: 'حلول مسائل رياضيات — جبر — حساب تفاضلي — احصاء — أي مستوى', descriptionEn: 'Math problem solutions — Algebra — Calculus — Statistics — Any level', price: 166667000, category: 'academic', emoji: '🔢', active: true },
  { id: 42, name: 'حلول فيزياء', nameEn: 'Physics Solutions', description: 'حلول مسائل فيزياء — ميكانيكا — كهرباء — أي مستوى', descriptionEn: 'Physics problem solutions — Mechanics — Electricity — Any level', price: 166667000, category: 'academic', emoji: '⚛️', active: true },
  { id: 43, name: 'تصميم CV / سيرة ذاتية', nameEn: 'CV / Resume Design', description: 'تصميم سيرة ذاتية احترافية — جذابة — متوافقة مع ATS', descriptionEn: 'Professional CV/Resume design — Eye-catching — ATS-friendly', price: 333333000, category: 'academic', emoji: '📋', active: true },
  // ⚡ خدمات عامة
  { id: 44, name: 'إعداد سيرفر Discord', nameEn: 'Discord Server Setup', description: 'إعداد سيرفر كامل — رولات + قنوات + صلاحيات + بوتات + ترحيب', descriptionEn: 'Full Discord server setup — Roles + Channels + Bots + Rules', price: 500000000, category: 'general', emoji: '🎮', active: true },
  { id: 45, name: 'مساعدة برمجية', nameEn: 'Programming Tutoring', description: 'مساعدة في أي لغة برمجة — Python, JS, C++, Java, PHP', descriptionEn: 'One-on-one programming tutoring — Python, JS, C++, Java, PHP', price: 333333000, category: 'general', emoji: '💻', active: true },
  { id: 46, name: 'كتابة محتوى تسويقي', nameEn: 'Copywriting', description: 'كتابة محتوى تسويقي — إعلانات — وصف منتج — سوشيال ميديا', descriptionEn: 'Marketing copywriting — Ads — Product descriptions — Social media', price: 333333000, category: 'general', emoji: '📢', active: true },
  { id: 47, name: 'إدارة سوشيال ميديا', nameEn: 'Social Media Management', description: 'إدارة حسابات سوشيال ميديا — محتوى + جدولة + تفاعل', descriptionEn: 'Social media management — Content + Scheduling + Engagement', price: 1666667000, category: 'general', emoji: '📱', active: true },
  { id: 48, name: 'إعداد متجر إلكتروني', nameEn: 'E-commerce Store Setup', description: 'إعداد متجر إلكتروني كامل — منتجات + سلة + دفع إلكتروني', descriptionEn: 'Full e-commerce store — Products + Cart + Payment gateway', price: 3333333000, category: 'general', emoji: '🛒', active: true },
];
